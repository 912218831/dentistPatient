...
- (void)setupWithFrame:(CGRect)frame
{
    ...
    if (searchField) {
        [searchField setValue:COLOR_999999 forKeyPath:@"_placeholderLabel.textColor"];
        [searchField setValue:FONT(TF14) forKeyPath:@"_placeholderLabel.font"];
        [searchField setValue:@(NSTextAlignmentCenter) forKeyPath:@"_placeholderLabel.textAlignment"];
    }
}
